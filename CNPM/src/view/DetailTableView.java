...
//		titleView
		...
		tittle.setBounds(118, 0, 392, 30);
		pn1.add(tittle);

//		JLabel lblTableName = new JLabel(table.getTableName());
		JLabel lblTableName = new JLabel("Môn Toán Học"); // ví dụ
		...
		lblTableName.setBounds(0, 43, 600, 23);
...
//		JLabel lblNumberQuestionUse = new JLabel("Số lượng câu hỏi: " + table.getNumberQuestionUse());
		...
		lblNumberQuestionUse.setFont(new Font("Tahoma", Font.BOLD, 13));
...
//		pn2.setBackground(Color.yellow);
		...
		btnCodeManager.setBounds(119, 25, 166, 55);
		btnCodeManager.setForeground(new Color(255, 255, 255));
		btnCodeManager.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		btnMark.setBounds(306, 25, 166, 55);
		btnMark.setForeground(new Color(255, 255, 255));
		btnMark.setFont(new Font("Tahoma", Font.BOLD, 15));
